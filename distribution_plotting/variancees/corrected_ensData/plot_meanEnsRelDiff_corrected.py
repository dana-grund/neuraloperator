...
"""
Script for plotting the relative differences (ground truth - prediction) in mean u over ensembles of the ensemble dataset.
...
fig.suptitle("Means Relative Error in u", fontsize=16, x=0.43, y=0.92)  # Raise the title
...
plt.savefig("ensPlots/MeanEnsRelDiffU_corrected.png")
