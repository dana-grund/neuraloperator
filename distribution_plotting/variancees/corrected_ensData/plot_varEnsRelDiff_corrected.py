...
"""
Script for plotting the relative differences (ground truth - prediction) in variance in u over ensembles of the ensemble dataset.
...
fig.suptitle("Variances Relative Error in u", fontsize=16, x=0.43, y=0.92)  # Raise the title
...
plt.savefig("ensPlots/VarEnsRelDiffU_corrected.png")
