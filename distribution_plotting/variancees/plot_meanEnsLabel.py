...
"""
Script for plotting the mean horizontal ground truth velocity at each point over an ensembles.
...
fig.suptitle("Label Means in u", fontsize=16, x=0.43, y=0.92)  # Raise the title
