...
"""
Script for computing the relative differnce between variance over the members of an ensemble 
...
print("\nAverage relative absolute variance differences\n")
...
for i in range(10):
    ...
    sigs_in_err = np.abs(sigs_in_lab - sigs_in_pred) / np.abs(sigs_in_lab)
