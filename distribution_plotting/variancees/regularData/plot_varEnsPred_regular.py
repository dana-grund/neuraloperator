...
"""
Script for plotting predicted u variance of the baseline dataset.
...
fig.suptitle("Predicted Variances in u - Regular Data", fontsize=16, x=0.43, y=0.92)  # Raise the title
...
plt.savefig("ensPlots/VarEnsPredU_regular.png")
