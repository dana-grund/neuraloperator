...
"""
Script for plotting the differences (ground truth - prediction) in mean v over ensembles of the baseline dataset.
...
fig.suptitle("Mean Differences in v - Regular Data", fontsize=16, x=0.43, y=0.92)  # Raise the title
...
plt.savefig("ensPlots/MeanEnsDiffV_regular.png")
