...
"""
Script for plotting the differences (ground truth - prediction) in variance in u over ensembles of the baseline dataset.
...
fig.suptitle("Variances Differences in u - Regular Data", fontsize=16, x=0.43, y=0.92)  # Raise the title
...
plt.savefig("ensPlots/VarEnsDiffU_regular.png")
