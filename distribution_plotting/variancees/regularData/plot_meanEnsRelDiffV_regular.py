...
"""
Script for plotting the relative differences (ground truth - prediction) in mean u over ensembles of the baseline dataset.
...
fig.suptitle("Relative Mean Differences in v - Regular Data", fontsize=16, x=0.43, y=0.92)  # Raise the title
...
plt.savefig("ensPlots/MeanEnsRelDiffV_regular.png")
