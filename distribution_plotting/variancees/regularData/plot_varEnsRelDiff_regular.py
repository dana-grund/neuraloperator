...
"""
Script for plotting the relative differences (ground truth - prediction) in variance in u over ensembles of the baseline dataset.
...
for i in range(10):
    ...
    sigs_in_err = (sigs_in_lab - sigs_in_pred) / sigs_in_lab
...
fig.suptitle("Variances Relative Differences in u - Regular Data", fontsize=16, x=0.43, y=0.92)  # Raise the title
...
plt.savefig("ensPlots/VarEnsRelDiffU_regular.png")
