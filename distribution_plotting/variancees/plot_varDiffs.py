...
"""
Script for plotting the relative errors in variance over an ensembles at each point for u and v averaged over all ten ensembles.
...
plt.savefig("meanRelativeVarDiffs.png")