...
"""
Script for plotting the relative differences in variance over an ensembles at each point for u and v averaged over all ten ensembles.
The differnces here are not absolute. Negative means the prediction is too big, positive means the prediction is to small.
Plots both for ensemble data and stability data.
"""
...
fig.suptitle("Mean Relative Variance Errors", fontsize=16, x=0.43, y=0.85)  # Raise the title
...
plt.savefig("meanRelativeVarDiffsNotAbs.png")