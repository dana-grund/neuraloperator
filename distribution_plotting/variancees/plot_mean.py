...
"""
Script for plotting the means of u and v over all velocities of all ten ensembles of the ensemble data.
Plots both prediction and ground truth.
"""
...
for i in range(10):
    ...
    sigs_pred = np.mean(pred, axis=0)
    sigs_lab = np.mean(label, axis=0)
...
fig.suptitle("Mean Means", fontsize=16, x=0.5, y=0.95)  # Raise the title
