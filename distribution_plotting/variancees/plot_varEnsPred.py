...
"""
Script for plotting the variance over an ensembles at each point for u.
Plots for all ten gound predicted ensembles of the ensemble dataset.
"""
...
for i in range(10):
    ...
    col = i % 2
    row = i // 2
    caxList.append(axs[row,col].imshow(sigs_in_pred, extent=[0, 127, 0, 127]))
...
fig.suptitle("Predicted Variances in u", fontsize=16, x=0.43, y=0.92)  # Raise the title
