...
"""
Script for plotting the differences in variance over an ensembles at each point for v.
...
fig.suptitle("Variance Errors in v", fontsize=16, x=0.43, y=0.92)  # Raise the title
...
plt.savefig("meanVarDiffsEnsNotAbsV.png")