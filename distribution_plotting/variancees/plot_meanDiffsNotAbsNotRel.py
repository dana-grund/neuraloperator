...
"""
Script for plotting the means of the differences/errors in u and v for all velocities of an ensemble.
...
fig.suptitle("Mean Mean Errors", fontsize=16, x=0.43, y=0.85)  # Raise the title
...
plt.savefig("meanMeanDiffsNotAbs.png")