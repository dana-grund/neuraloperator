...
"""
Script for plotting the errors in variance over an ensembles at each point for u and v averaged over all ten ensembles.
...
for i in range(10):
    ...
    rel_sig_errors = np.abs(sigs_in_lab - sigs_in_pred)
