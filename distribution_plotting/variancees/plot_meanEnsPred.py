...
"""
Script for plotting the mean horizontal predicted velocity at each point over an ensembles.
Plots all ten ensembles of the ensemble data.
"""
...
fig.suptitle("Predicted Means in u", fontsize=16, x=0.43, y=0.92)  # Raise the title
