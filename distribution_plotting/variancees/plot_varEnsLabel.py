...
Plots for all ten gound truth ensembles of the ensemble dataset.
"""
...
fig.suptitle("Label Variances in u", fontsize=16, x=0.43, y=0.92)  # Raise the title
