...
"""
Script for ploting u field at timestep 0 and prediction and ground truth at the final timestep.
...
#divider = make_axes_locatable(axs[row,col])
#cax = divider.append_axes("right", size="6%", pad=0.06)
fig.colorbar(caxList[-1], ax=axs[2], fraction=0.046, pad=0.04)
...
fig.suptitle("Regular Label vs Prediction - u", fontsize=16, x=0.43, y=0.72)  # Raise the title
...
plt.savefig(f"firstLastBothRegular1.png")
...
plt.savefig(f"firstLastBothEnsemble1.png")