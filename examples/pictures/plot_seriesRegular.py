...
"""
Script for plotting series of u fields of all timesteps for a sample of the regular dataset.
"""
...
for i in range(11):
    ...
    im = axs[row,col].imshow(np.transpose(field[0], axes=(1,0)), extent=[0, 127, 0, 127], cmap='seismic', vmin=-absMax, vmax=absMax)
    caxList.append(im)
...
fig.suptitle("Evolution of Ground Truth u", fontsize=16, x=0.5, y=0.98)  # Raise the title
...
plt.savefig("uSeriesRegularSeismic_new.png")
