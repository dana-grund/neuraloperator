...
"""
Script for plotting u and v fields of a sample from the ensemble dataset at timestep 0.
"""
...
data = ensemble_loaders[0].dataset[0]
...
plt.savefig("initialsEnsembleInDist.png")
