...
"""
Script for plotting the ground truth u fields of ten samples of the first ensemble of the ensemble dataset.
"""
...
for i in range(10):
    ...
    col = i % 5
    row = i // 5
    caxList.append(axs[row,col].imshow(field[0], extent=[0, 127, 0, 127]))
...
fig.suptitle(f"Ensemble {j+1} - Label u", fontsize=16, x=0.43, y=0.92)  # Raise the title
...
plt.savefig(f"uEnsemble{j+1}.png")
