...
"""
Script for computing errors in ensemble mean velocities for the naive estimator on the ensemble dataset.
"""
...
print("\nNaive, average absolute mean differences - ensemble set\n")
...
for i in range(10):
    ...
    sigs_in_pred = np.mean(ensemble_x, axis=0)
    sigs_in_lab = np.mean(ensemble_y, axis=0)
