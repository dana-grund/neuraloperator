...
"""
Script for computing difference in ensemble mean velocities for the naive estimator on the ensemble dataset.
...
print("\nNaive, average mean differences - ensemble set\n")
