...
from plot_spectra import forwardPass, transformTotEnergie, transformOneCompEnergy, plotMulti1DSpectrum

"""
Script for plotting 1D spectra of the total kinetic energie of prediction and ground truth of 2 samples of the baseline dataset.
"""
