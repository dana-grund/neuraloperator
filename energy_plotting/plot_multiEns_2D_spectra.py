...
from plot_spectra import forwardPass, transformTotEnergie, transformOneCompEnergy, plotMulti2DSpectrumDiffEns

"""
Script for plotting 3 different 2D spectra of the total kinetic energies of predictions of samples from the enemble dataset.
"""
...
plotMulti2DSpectrumDiffEns(transforms, frequencies, 'Total', labelTransf=labelTransf, regularData=True)