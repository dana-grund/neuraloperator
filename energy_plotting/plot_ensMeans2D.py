...
from plot_spectra import forwardPass, transformTotEnergie, transformOneCompEnergy, plotMulti2DSpectrumDiffEns, plotMulti2DSpectrum_ensembles

"""
Script for plotting 2D total kinetic energy spectra for all ensembles of the ensemble dataset.
Plots ensemble means.
"""
...
plotMulti2DSpectrum_ensembles(transforms, frequencies, 'Total', labelTransf=labelTransf, regularData=False)